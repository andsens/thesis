...
The EBNF for mustache is a fairly simple one.
\begin{figure}
	\centering
...
able to create DOM paths through this tree. The following EBNF represents the
structure of the parser in our tool.
\begin{figure}
	\centering
...
illustrates the difference very well, once we add a last list element:
\begin{figure}
	\centering
