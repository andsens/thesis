...
it passes. They also allow use to create proper abstract syntax trees for any
template.
...
in the TagSoup library (\todo{Ref to Text.HTML.TagSoup.Entity}). The
\inline{lookupEntity} function converts XML character references to UTF-8
characters.
...
locations.
These overlay techniques would very quickly dwarf the 250 lines of code our
