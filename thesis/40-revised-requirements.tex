...
(\ref{app:mustache}). Mustache is a templating language that is very
...
Template Engines'' \cite{STRINGTPL}. \todo{OK to just cite and then leave it at
that?}
...
\item underscore.js helps us to iterate through arrays and manage other
	...
	without it\footnote{although it requires more effort.}.
