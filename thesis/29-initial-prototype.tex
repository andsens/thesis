...
\begin{itemize}
	...
	scope with the \inline{extract} method.
...
DOM anyways \todo{better wording}.
...
The Models need to be created when the page has loaded. To that end we use the
...
\end{itemize}
\todo{We have not talked about the "process" function, it is a drawback}
