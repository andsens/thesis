...
We use chaplin\footnote{See section \ref{sec:chaplin}} to structure our
...
Twitter Bootstrap\footnote{See section \ref{sec:bootstrap}} library to style the
...
template\footnote{
	Section \ref{sec:update-dom} explains this necessity in more detail.
}.
\end{document}
