...
\begin{figure}
	\centering
	\resizebox{\linewidth}{!}{\includegraphics{graphics/moviedb-prototype}}
...
\begin{figure}
	\centering
	\resizebox{\linewidth}{!}{\includegraphics{graphics/moviedb-bootstrap}}
...
leaves us with a clear picture of the robustness\todo{Ref to Rule of robustness}
Comb has with respect to retrieving values from the DOM.
...
\begin{figure}
	\centering
	\resizebox{\linewidth}{!}{\includegraphics{graphics/template-selection}}
...
\begin{figure}
	\centering
	\resizebox{\linewidth}{!}{\includegraphics{graphics/editor-form}}
