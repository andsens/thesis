...
\section{}
\todo{This is hard to split up into paragraphs. Restructure?}
...
\subsection{The consequence of the simplification}
...
\todo{Why not simply make the template engine understand subviews?
Because we at rendering time would have to render eeeeverything}
...
\todo{Not only server side anymore/single page apps}
