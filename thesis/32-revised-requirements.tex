...
be desired. Removing such a feature may reduce the immediate usefulness of our
tool; it increases the applicability of it however.
A mapping layer may still be put on top of our tool to abstract raw data
into backbone models.
Such a mapping layer could however also be a form validation tool or a custom
