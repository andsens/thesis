...
In \ref{chap:architecture} we evaluated that strategy but discovered that the
strings returned by the \inline{innerHTML} property of DOM elements differ
between browsers and do not reflect the original rendered template.
...
\subsection{Paper by Elsman and Larsen} % SMLserver based combinator library as title
