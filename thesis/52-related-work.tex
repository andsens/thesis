...
\todo{Make the point that the focus should shift to tools, disruptive innovation}
...
Frameworks such as MAWL, the typed templates in ML or Dynamic Web Documents
use an all-or-nothing approach when it comes to typing templates and
